    ...
    fetch(options.config)
      ...
      .then(config => {
        ...
        function render() {
          ...
          // Calculate deferral and repayment months for BNPL with deferral terms
          let repaymentDisplayMonths = selectedTerm; // default
          if (
          ...
          let summaryHTML = `
            <div class="summary-section">
              ...
              ${
                deferralMonths
                  ? `<p><strong>Deferral period:</strong> ${deferralMonths} months</p>`
                  : ''
              }
